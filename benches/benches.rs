...
fn bench_day21(c: &mut Criterion) {
    use aoc::solutions::year2020::day21::{part1, part2};
    let raw_input = aoc::input::get_input(2020, 21).unwrap();
    c.bench_function("day21 part 1", |b| b.iter(|| part1(&raw_input)));
...
fn bench_day23(c: &mut Criterion) {
    use aoc::solutions::year2020::day23::{part1, part2};
    let raw_input = aoc::input::get_input(2020, 23).unwrap();
    c.bench_function("day23 part 1", |b| b.iter(|| part1(&raw_input)));
    c.bench_function("day23 part 2", |b| b.iter(|| part2(&raw_input)));
}

fn bench_day24(c: &mut Criterion) {
    use aoc::solutions::year2020::day24::{part1, part2};
    let raw_input = aoc::input::get_input(2020, 24).unwrap();
    c.bench_function("day24 part 1", |b| b.iter(|| part1(&raw_input)));
    c.bench_function("day24 part 2", |b| b.iter(|| part2(&raw_input)));
}

fn bench_day25(c: &mut Criterion) {
    use aoc::solutions::year2020::day25::part1;
    let raw_input = aoc::input::get_input(2020, 25).unwrap();
    c.bench_function("day25 part 1", |b| b.iter(|| part1(&raw_input)));
}
